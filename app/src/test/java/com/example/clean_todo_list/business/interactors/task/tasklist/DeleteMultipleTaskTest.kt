...
import com.example.clean_todo_list.business.interactors.task.tasklist.DeleteMultipleTask.Companion.DELETE_TASKS_ERRORS
import com.example.clean_todo_list.business.interactors.task.tasklist.DeleteMultipleTask.Companion.DELETE_TASKS_SUCCESS
...
class DeleteMultipleTaskTest {
    ...
    fun deleteTasks_success_confirmCacheAndNetworkUpdated() = runBlocking {
        val tasksInCache = taskCacheDataSource.searchTask("", SortAndOrder.CREATED_DATE_ASC, 1)
        ...
        val tasksInCacheAfterDelete = taskCacheDataSource.searchTask("", SortAndOrder.CREATED_DATE_ASC, 1)
    ...
    fun deleteTasks_fail_confirmCacheAndNetworkUpdatedViaSuccessfulOnes() = runBlocking {
        ...
        val tasksInCacheBeforeDelete = taskCacheDataSource.searchTask("", SortAndOrder.CREATED_DATE_ASC, 1)
